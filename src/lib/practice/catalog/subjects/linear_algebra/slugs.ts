...
export const LA4 = getModuleSlugs(LA_SUBJECT_SLUG, LA_MOD4);
...
export const LA_SECTION_MOD4 = LA4.section;
...
export const LA_GENKEY_MOD4 = LA4.genKey;
...
export const LA_TOPIC_MOD4 = LA4.topics;
