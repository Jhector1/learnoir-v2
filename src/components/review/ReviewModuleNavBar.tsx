            ...
            >
                <div className="mx-auto max-w-6xl px-4 md:px-6 pb-[max(env(safe-area-inset-bottom),0px)]">
                    <div
                        className={cn(
                            "ui-card",
                            "bg-white/70 backdrop-blur-xl dark:bg-black/55",
                            // remove “floating shadow line”
                            "shadow-none",
                            // optional: subtle divider instead of shadow
                    ...
                    >
                        ...
                        {isLastModule && !canGetCertificate ? (
                            <div className="mt-2 text-xs text-neutral-600 dark:text-white/60">
                                Complete this module to unlock your{" "}
                                <span className="font-black">certificate</span>.
                            </div>
                        ) : null}
                    </div>
                </div>
