...
import {PY_VARIABLES_TYPES_TOPICS} from "@/lib/subjects/python/modules/module0/topics/py_variables_types.topics";
import {
    PY_OPERATORS_EXPRESSIONS_TOPICS
} from "@/lib/subjects/python/modules/module0/topics/operators_expressions.topics";
